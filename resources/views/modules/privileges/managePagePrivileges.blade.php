...
<style>
/* ===== Shell ===== */
.mpriv-scope.cm-wrap{padding:2px 0;overflow:visible}
.mpriv-scope .mpriv-head{padding:10px 12px;margin-bottom:12px}
.mpriv-scope .mpriv-head-row{display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap}
.mpriv-scope .mpriv-head-copy{display:flex;align-items:center;min-height:30px}
.mpriv-scope .mpriv-head-copy h1{margin:0;font-size:var(--fs-15);line-height:1.15;display:flex;align-items:center;gap:6px}
.mpriv-scope .mpriv-head-copy .seg-muted{color:var(--muted-color);font-weight:500}
.mpriv-scope .mpriv-head-copy .seg-sep{color:var(--muted-color);opacity:.7}
.mpriv-scope .mpriv-head-actions{display:flex;align-items:center;gap:8px}
.mpriv-scope .mpriv-refresh-btn{min-width:30px;width:30px;height:30px;padding:0;display:inline-flex;align-items:center;justify-content:center}
.mpriv-scope .mpriv-refresh-btn.is-spinning i{animation:mprivSpin .8s linear infinite}
@keyframes mprivSpin{to{transform:rotate(360deg)}}
.mpriv-scope .mpriv-toolbar{padding:10px;margin-bottom:12px}
.mpriv-scope .mpriv-search-wrap{position:relative;min-width:260px;flex:1 1 320px}
.mpriv-scope .mpriv-search-wrap .fa-search{position:absolute;left:10px;top:50%;transform:translateY(-50%);opacity:.55;pointer-events:none}
.mpriv-scope .mpriv-search-wrap .form-control{padding-left:34px}
.mpriv-scope .mpriv-inline-actions{display:flex;gap:8px;flex-wrap:wrap;align-items:center}
.mpriv-scope .mpriv-inline-actions .btn{white-space:nowrap}
.mpriv-scope .panel{background:var(--surface);border:1px solid var(--line-strong);border-radius:16px;box-shadow:var(--shadow-2);padding:12px}

/* Toolbar */
.mpriv-scope .mpriv-toolbar .form-control,
.mpriv-scope .mpriv-toolbar .form-select,
.mpriv-scope .mpriv-toolbar .btn{min-height:40px}
.mpriv-scope .mpriv-toolbar .text-muted.small{line-height:1}
.mpriv-scope .mpriv-toolbar #sortHint{font-weight:500}

/* Table Card */
.mpriv-scope .table-wrap.card{position:relative;border:1px solid var(--line-strong);border-radius:16px;background:var(--surface);box-shadow:var(--shadow-2);overflow:visible}
.mpriv-scope .table-wrap .card-body{overflow:visible}
.mpriv-scope .table-responsive{overflow:visible !important}
.mpriv-scope .table{--bs-table-bg:transparent}
.mpriv-scope .table thead th{font-weight:600;color:var(--muted-color);font-size:13px;border-bottom:1px solid(var(--line-strong));background:var(--surface)}
.mpriv-scope .table thead.sticky-top{z-index:3}
.mpriv-scope .table tbody tr{border-top:1px solid var(--line-soft)}
.mpriv-scope .table tbody tr:hover{background:var(--page-hover)}
.mpriv-scope .small{font-size:12.5px}

/* Sorting */
.mpriv-scope .sortable{cursor:pointer;white-space:nowrap}
.mpriv-scope .sortable .caret{display:inline-block;margin-left:.35rem;opacity:.65}
.mpriv-scope .sortable.asc .caret::after{content:"▲";font-size:.7rem}
.mpriv-scope .sortable.desc .caret::after{content:"▼";font-size:.7rem}

/* Row state cues */
.mpriv-scope tr.state-archived td{background:color-mix(in oklab, var(--muted-color) 6%, transparent)}
.mpriv-scope tr.state-deleted td{background:color-mix(in oklab, var(--danger-color) 6%, transparent)}

/* Status badges */
.mpriv-scope .badge-soft{background:color-mix(in oklab, var(--muted-color) 12%, transparent);color:var(--ink)}
.mpriv-scope .table .badge.badge-success{background:var(--success-color)!important;color:#fff!important}
.mpriv-scope .table .badge.badge-secondary{background:#64748b!important;color:#fff!important}

/* Dropdowns inside table (with portal) */
.mpriv-scope .table-wrap .dropdown{position:relative;z-index:6}
.mpriv-scope .table-wrap .dd-toggle{position:relative;z-index:7}
.mpriv-scope .dropdown [data-bs-toggle="dropdown"]{border-radius:10px}
.mpriv-scope .table-wrap .dropdown-menu{border-radius:12px;border:1px solid var(--line-strong);box-shadow:var(--shadow-2);min-width:220px;z-index:5000}
.dropdown-menu.mpriv-dd-portal{position:fixed!important;left:0;top:0;transform:none!important;z-index:5000;border-radius:12px;border:1px solid var(--line-strong);box-shadow:var(--shadow-2);min-width:220px;background:var(--surface)}
.mpriv-scope .dropdown-item{display:flex;align-items:center;gap:.6rem}
.mpriv-scope .dropdown-item i{width:16px;text-align:center}
.mpriv-scope .dropdown-item.text-danger{color:var(--danger-color)!important}
.dropdown-menu.mpriv-dd-portal .dropdown-item{display:flex;align-items:center;gap:.6rem}
.dropdown-menu.mpriv-dd-portal .dropdown-item i{width:16px;text-align:center}
.dropdown-menu.mpriv-dd-portal .dropdown-item.text-danger{color:var(--danger-color)!important}

/* Buttons */
.mpriv-scope .icon-btn{display:inline-flex;align-items:center;justify-content:center;height:34px;min-width:34px;padding:0 10px;border:1px solid var(--line-strong);background:var(--surface);border-radius:10px}
.mpriv-scope .icon-btn:hover{box-shadow:var(--shadow-1)}

/* Empty & loader */
.mpriv-scope .empty{color:var(--muted-color)}
.mpriv-scope .placeholder{background:linear-gradient(90deg,#00000010,#00000005,#00000010);border-radius:8px}

/* Modals */
.mpriv-scope .modal-content{border-radius:16px;border:1px solid var(--line-strong);background:var(--surface)}
.mpriv-scope .modal-header{border-bottom:1px solid var(--line-strong)}
.mpriv-scope .modal-footer{border-top:1px solid var(--line-strong)}
.mpriv-scope .form-control,.mpriv-scope .form-select,.mpriv-scope textarea{border-radius:12px;border:1px solid var(--line-strong);background:#fff}
html.theme-dark .mpriv-scope .form-control,html.theme-dark .mpriv-scope .form-select,html.theme-dark .mpriv-scope textarea{background:#0f172a;color:#e5e7eb;border-color:var(--line-strong)}

/* Reorder affordances (only for archived/bin tables now) */
.mpriv-scope .dragging{opacity:.6}
.mpriv-scope .drag-handle{cursor:grab;color:#9ca3af}
.mpriv-scope .drag-handle:active{cursor:grabbing}

/* Dark tweaks */
html.theme-dark .mpriv-scope .panel,
html.theme-dark .mpriv-scope .table-wrap.card,
html.theme-dark .mpriv-scope .modal-content{background:#0f172a;border-color:var(--line-strong)}
html.theme-dark .mpriv-scope .table thead th{background:#0f172a;border-color:var(--line-strong);color:#94a3b8}
html.theme-dark .mpriv-scope .table tbody tr{border-color:var(--line-soft)}
html.theme-dark .mpriv-scope .dropdown-menu,
html.theme-dark .dropdown-menu.mpriv-dd-portal{background:#0f172a;border-color:var(--line-strong)}

/* Ensure common wrappers don't clip dropdowns */
.mpriv-scope .table-responsive,
.mpriv-scope .table-wrap,
.mpriv-scope .card,
.mpriv-scope .panel,
.mpriv-scope.cm-wrap {
...
.dropdown-menu.mpriv-dd-portal.dropdown-menu-end.show {
...
.mpriv-scope .priv-rows .row { gap: .5rem; align-items: center; margin-bottom: .5rem; }
.mpriv-scope .priv-rows .col-action { flex: 1 1 25%; }
.mpriv-scope .priv-rows .col-api    { flex: 1 1 35%; }
.mpriv-scope .priv-rows .col-module { flex: 1 1 15%; }
.mpriv-scope .priv-rows .col-desc   { flex: 1 1 25%; }
.mpriv-scope .priv-rows .col-remove { flex: 0 0 48px; text-align: right; }

/* ===== ACTIVE TAB ACCORDION VIEW ===== */
.mpriv-scope .priv-accordion .accordion-item{
  border-radius:12px;
  overflow:hidden;
...
.mpriv-scope .priv-accordion .accordion-button{
  display:flex;
  align-items:center;
...
.mpriv-scope .priv-accordion .accordion-button:not(.collapsed){
  background:var(--surface-soft);
  box-shadow:none;
}
.mpriv-scope .priv-accordion .accordion-button:focus{
  box-shadow:0 0 0 1px var(--primary-color);
}
.mpriv-scope .priv-accordion .priv-module-pill{
  font-size:0.75rem;
  border-radius:999px;
  padding:2px 10px;
  background:var(--background-soft);
...
.mpriv-scope .priv-accordion .priv-add-wrap{
  display:flex;
  flex-wrap:wrap;
  align-items:center;
  gap:.5rem;
...
.mpriv-scope .priv-accordion .priv-add-wrap .form-select,
.mpriv-scope .priv-accordion .priv-add-wrap .form-control{
  height:36px;
  border-radius:10px;
}

.mpriv-scope .priv-accordion .list-group-item{
  border:none;
  border-radius:10px;
  margin-bottom:6px;
  background:var(--background-soft);
}
.mpriv-scope .priv-accordion .list-group-item .fw-semibold{
  font-size:0.9rem;
}
.mpriv-scope .priv-accordion .list-group-item .badge{
  font-size:0.68rem;
}

html.theme-dark .mpriv-scope .priv-accordion .list-group-item{
  background:#0b1220;
}
</style>
@endpush
...
<div class="cm-wrap mpriv-scope">
  ...
  <div class="panel mpriv-head">
    <div class="mpriv-head-row">
      <div class="mpriv-head-copy">
        <h1>
          <span class="seg-muted">Page Privileges</span>
          <span class="seg-sep">/</span>
          <span>Manage</span>
        </h1>
      </div>

      <div class="mpriv-head-actions">
        <button type="button" class="btn btn-light mpriv-refresh-btn" id="btnPrivRefresh" title="Refresh" aria-label="Refresh">
  ...
  <div class="tab-content mb-3">
    ...
    <div class="tab-pane fade show active" id="tab-active" role="tabpanel">
      ...
      <div class="panel mpriv-toolbar mfa-toolbar">
        <div class="row g-2 align-items-center">
          <div class="col-12 col-xl">
            <div class="mpriv-inline-actions">
              ...
              <div class="mpriv-search-wrap">
                <input id="q" type="text" class="form-control" placeholder="Search action, description or module">
                <i class="fa fa-search"></i>
              </div>

              <button id="btnSearch" class="btn btn-primary"><i class="fa fa-search me-1"></i>Search</button>
              <button id="btnReset" class="btn btn-light"><i class="fa fa-rotate-left me-1"></i>Reset</button>
            </div>
          </div>

          <div class="col-12 col-xl-auto">
            <div class="mpriv-inline-actions justify-content-xl-end">
...
(function(){
  ...
  (function(){
    ...
    const place=(menu, btnRect)=>{
      ...
      menu.classList.add('dd-portal','mpriv-dd-portal'); menu.style.display='block'; menu.style.visibility='hidden';
    ...
    document.addEventListener('hidden.bs.dropdown', (ev)=>{
      ...
      if(menu.__parent){
        menu.classList.remove('dd-portal','mpriv-dd-portal');
        menu.style.cssText='';
  ...
  (function(){
    ...
    const btnRefresh = document.getElementById('btnPrivRefresh');
    ...
    btnSearch && btnSearch.addEventListener('click', runSearch);
    ...
    // Tab events
    document.querySelector('a[href="#tab-active"]')?.addEventListener('shown.bs.tab', ()=>{ activeScope='active'; load('active'); });
    document.querySelector('a[href="#tab-archived"]')?.addEventListener('shown.bs.tab', ()=>{ activeScope='archived'; load('archived'); });
    document.querySelector('a[href="#tab-bin"]')?.addEventListener('shown.bs.tab', ()=>{ activeScope='bin'; load('bin'); });
